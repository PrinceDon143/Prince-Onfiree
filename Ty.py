...
\033[1;37m  /  _  \   ____ |__| _____|  |__  \x1b[94m V
\033[1;37m /  /_\  \ /    \|  |/  ___/  |  \ \x1b[95m I
\033[1;37m/    |    \   |  \  |\___ \|   Y  \\\x1b[96m P
\033[1;37m\____|__  /___|  /__/____  >___|  /
\033[1;37m        \/     \/        \/     \/ 
\033[1;37m-----------------------------------------------
\033[1;37m[\033[1;32m=\033[1;37m] DEVELOPER   :   ANISH-XD
...
class create:
    ...
    'viewport-width': '980',}
        ...
        for x in range(lim):
            self.loop += 1
            sys.stdout.write(f'\r{OO}[ANISH-XD] {OO}{self.loop}/{str(lim)} OK: {len(ok)} = CP: {len(cp)}{OO} '),
            sys.stdout.flush()
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;33m[ANISH-CP] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    ...
                                    cok = self.ses.cookies.get_dict()
                                    print ('\r\033[1;32m[ANISH-OK] '+cok['c_user']+' | '+passw+' | '+coki+'\033[0;97m     ')
